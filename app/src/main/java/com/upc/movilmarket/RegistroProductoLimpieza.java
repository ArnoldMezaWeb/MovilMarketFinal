...
public class RegistroProductoLimpieza extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_registro_producto_limpieza);
        inicializarFirebase();
        asignarReferencias();
    }
    ...
    private void asignarReferencias(){
        ...
        storageReference = FirebaseStorage.getInstance().getReference().child("Limpieza");
        cargando = new ProgressDialog(this);

        btnseleccionar.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                CropImage.startPickImageActivity(RegistroProductoLimpieza.this);
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if(requestCode==CropImage.PICK_IMAGE_CHOOSER_REQUEST_CODE && resultCode == Activity.RESULT_OK){
            ...
            CropImage.activity(imagenuri)
                    ...
                    .setAspectRatio(2, 1).start(RegistroProductoLimpieza.this);
            ...
            if (resultCode ==RESULT_OK){
                ...
                btnRegistrar.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        AlertDialog.Builder ventana = new AlertDialog.Builder(RegistroProductoLimpieza.this);
                        ventana.setTitle("Mensaje Informativo");
                        ventana.setMessage("Se registro Correctamente");
                        ventana.setPositiveButton("Aceptar", new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialog, int which) {
                                Intent intent = new Intent(RegistroProductoLimpieza.this, LimpiezaActivity.class);
                  ...
                  */
                        ...
                        Task<Uri> uriTask = uploadTask.continueWithTask(new Continuation<UploadTask.TaskSnapshot, Task<Uri>>() {
                            ...
                            public void onComplete(@NonNull Task<Uri> task) {
                                ...
                                dbReference.child("Limpieza").child(p.getId()).setValue(p);
